...
export const getMessageForDetails = (details) => {
  ...
  switch (paymentDetails.status) {
    case PAYMENT_DETAILS_STATUS.MISSING:
      return {
        msg: "[Payment Section Incomplete] To update events and services, please add your Payment details.",
        type: ALERT_BANNER_TYPES.WARNING,
      };
    case PAYMENT_DETAILS_STATUS.RZP_PENDING:
      return {
        msg: "[Account Under Processing] Thank you for submitting your Payment details. Your account will be activated soon.",
