...
function SoloprenuerAdvantages({ content }) {
  ...
  return (
    <Grid container className={classes.outerContainer}>
      <img src="/assets/solopreneur/advantages-bg1.svg" alt="background-image" className={classes.bgImg1}></img>
     <img src="/assets/solopreneur/advantages-bg2.svg" alt="background-image" className={classes.bgImg2}></img>
          ...
          <Grid item xs={12} sm={6}>
            ...
            return (
                    <Grid container className={classes.list}> 
                        <Grid item p={1} className={classes.checkIcon} justifyContent={"center"}> 
                        <CheckIcon/>
                        </Grid>
