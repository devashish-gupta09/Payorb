         ...
         {/* This is for the desktop display of the cards*/}
            ...
            <Grid container className={classes.desktop} spacing={"2"}>
                {/* This is for the banner story of the cards*/}
                    ...
                    <Grid container justifyContent={"center"} alignItems={"center"} spacing="2"  justify={"space-evenly"}>
                        ...
                        <Typography gutterBottom variant="h6" className={classes.headline}>
                            ...
                            <Button size="small"className={classes.date}>{content.bannerStory.date}</Button>
                            <Button size="small" className={classes.readMore} justifyContent={"right"}>Read More</Button>
                            </Grid>
                        </Grid>
                        <Grid item sm={4} >
                            <img
                    ...
                    <Grid container className={classes.mobileView} alignItems="center" justifyContent="center" spacing={"2"}>
                        <Carousel
                         interval={2500}
