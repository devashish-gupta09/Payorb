...
export const ProfileImageGalleryCard = ({ link, type = 'image' }) => {
    ...
    return (<Grid className={classes.root}>
        <Grid className={classes.cardImage} style={{ backgroundImage: `url(${link})` }} />
        <Grid container className={classes.imageTitle} alignItems="center">
            <Typography className={classes.imageTitleText}>
                Inspiring UasdfsfsadfadsfsadfsadfadsfadsfasdfsafsafasdfsadfsadfsadfsadfI/UX Designer Portfolios That Take Design to the Next Level
            </Typography>
        </Grid>
