...
export const getUserRegistrationContent = async () => {
  try {
    ...
    return {
      ...
      image:
        "https://firebasestorage.googleapis.com/v0/b/payorb-92ef0.appspot.com/o/landing-page-assets%2Fsignup.png?alt=media&token=cd0f9b23-8f87-40fa-acea-8af667030fea",
    };
  }
};
